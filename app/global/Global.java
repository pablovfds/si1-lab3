...
public class Global extends GlobalSettings {
	...
	private List<Poster> createExampleAd() {
		...
		for(int i=1; i <= 50; i++) {
			...
			if(release < 0.35) {
				description = "busco musico para tocar em um show";
			} else if(release > 0.35 &&  release < 0.65) {
				description = "busco musico para ensaio";
			} else {
				description = "busco musico para teste";
			}
			...
			if(release < 0.35) {
				email = "musico_exemplo@gmail.com";
			} else if(release > 0.35 &&  release < 0.65) {
				email = "musico_exemplo2@gmail.com";
				profile = "https://www.facebook.com/musico_exemplo";
			} else {
				profile = "https://www.facebook.com/musico_exemplo2";
			}
